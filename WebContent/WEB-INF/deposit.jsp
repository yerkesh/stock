	...
	<div class="content">
		<div class="left">
			...
			<div class="login_option">
				...
				<div class="deposit_money"><a href="deposit.do" style="text-decoration: none; color: #F9460D;">DEPOSIT MONEY</a></div>
				<div class="create_fund"><a href="createFund.do" style="text-decoration: none; color: #A1A9A9;">CREATE FUND</a></div>
