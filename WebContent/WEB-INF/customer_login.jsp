	...
	<div class="content">
		<div class="left">
			...
			<div class="login_option">
				<div class="cust_login"><a href="customerLogin.do"  style="text-decoration: none; color: #F9460D;">CUSTOMER LOGIN</a></div>
				<div class="emp_login"><a href="employeeCredential.do" style="text-decoration: none; color: #A1A9A9;">EMPLOYEE LOGIN</a></div>
			</div>
		</div>
		
		<div class="right" style="background-color: #EAF7FD;">
			
			<h2 style="padding:10px; margin-left:30px;">Customer Login</h2>
